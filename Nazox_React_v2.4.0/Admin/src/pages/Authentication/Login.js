...
class Login extends Component {
  constructor(props) {
    super(props);
    this.state = { username: "admin@themesdesign.in", password: "12345" };
  }
...
function LoginForm(props) {
  ...
  const onSubmit = async () => {
    ...
    axios
      .post("http://localhost:8082/sclm/common-login/login", requestBody, {
        headers,
      })
      .then((response) => {
    ...
    props.checkLogin(credential, props.router.navigate);
  };
                      ...
                      <div>
                        <div className="text-center">
                          ...
                          <p className="text-muted">
                            Sign in to continue to Us Tod Survey.
                          </p>
                        </div>
                        {props.loginError && (
